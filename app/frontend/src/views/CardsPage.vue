    ...
    <div class="column q-gutter-lg">
      ...
      <q-card flat bordered class="bg-grey-10">
        <q-card-section class="row q-col-gutter-md">
          ...
          <q-select v-model="filters.cardCategory" class="col-6 col-md-2" dark outlined clearable label="Category" :options="['pokemon', 'trainer', 'energy', 'unknown']" />
          <q-select v-model="filters.variantType" class="col-6 col-md-2" dark outlined clearable label="Variant" :options="['normal', 'holo', 'reverse_holo', 'stamped', 'first_edition']" />
          <div class="col-12">
